...
function resolveFilePatterns(filesPattern, root) {
    return __awaiter(this, void 0, void 0, function* () {
        return (0, locter_1.locateFiles)(filesPattern, Object.assign({}, (root ? { path: root } : {}))).then((files) => files.map((el) => path_1.default.join(el.path, el.fileName + el.fileExtension)));
    });
}
